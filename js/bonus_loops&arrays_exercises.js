...
//create an array of shapes – prompt the user to search for a specific shape – using a for loop, iterate through the array to log the shapes until the matching shape is found – once the shape is found, log a message (“Shape is found”) and use a break statement to exit loop.

//Create a function that returns a random day of the week

//Create a function that takes a single letter and returns what number the letter is in the alphabet. Ignore case. – someFunction(“a”) // returns 1 – someFunction(“z”) // returns 26

//Create a function that returns the longest string in a given array of string elements.

//Create a function that takes in two arrays of elements, including numbers. If all numbers added together in the first array is equal to all the number inputs added in the second array, return true, otherwise, false. Only add together numeric elements but either array may contain non-numeric elements. – var arr1 = [‘bob’, 1, true, 1, 2]; – var arr2 = [2, null, undefined, 0, 2, “apple”] – exampleFunction(arr1, arr2) // returns true